...
if ciudad_filtro and ciudad_filtro not in ciudades:
    ...
    ciudad_idx = ciudades.index(ciudad_filtro) if ciudad_filtro else None
...
# Obtener los promedios según los filtros
resultado = calcular_promedio(ciudad_idx, semana_idx)

# Mostrar resultados
if resultado:
    for r in resultado:
        print(f"Promedio de {r['ciudad']}, Semana {r['semana']}: {r['promedio']}°C")
else:
